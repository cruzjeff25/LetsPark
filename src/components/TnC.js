    ...
    <>
      <div className='terms'>
        <div>
          ...
          <br/>
          <ul>
            <li>Copy or republish material from Let's Park! </li>
            <li>Sell, rent, or sub-license material from Let's Park! </li>
            <li>Reproduce, duplicate or copy material from Let's Park! </li>
            <li>Redistribute content from Let's Park! </li>
          </ul>
          <br/>
          <br/>
