                      ...
                      <td>Chua Rex
                        <div className="kebab-menu">
                          ...
                          {(index == selectedIndex.current) && isOpen && (
                            <ul>
                              <li><Link className='link' style={{ textDecoration: "none" }} to="/Admin/ParkingSpaces/Registered/ViewSpace" state={{ id: docId.current, approved: true }}> View Space</Link> </li>
                              <li><Link className='link' style={{ textDecoration: "none" }} to="/Admin/ParkingSpaces/Registered/ViewSpace" state={{ id: docId.current, approved: true }}> Edit Space</Link></li>
                              <li>Delete Space</li>
                            </ul>
                          )}
                        </div>
